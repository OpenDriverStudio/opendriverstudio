...
from src.opendriverstudio.database.database import DatabaseCreationError, DriverDatabase, MissingFieldError
...
class TestDriverDatabase:
    ...
    def test_database_select_all_from_drivers_table(
        ...
        db: DriverDatabase = setup_database_with_working_drivers_data
